...
## Change Log
- 2026-04-10: `AWF-264` opened after the first exact-lane range pass. The immediate follow-up question is no longer whether the lane exists, but how to interpret its short-window failures: `2h / 120d` remains structurally alive yet sample-limited under the current trade floor, while `1h / 180d` fails completely. The next decision is therefore about trade-floor policy and promotion criteria, not about reopening generic timeframe exploration.
