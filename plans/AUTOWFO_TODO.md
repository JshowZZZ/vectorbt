...
- Next action: Continue end-to-end baselines; run a third window with different timeframe/days and re-evaluate ranking trigger after accumulating multi-window evidence
