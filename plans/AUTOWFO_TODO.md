...
- Next action: Continue end-to-end baselines with a window/config that yields non-zero refine candidates; re-evaluate ranking trigger only on runs where refine executes meaningful additional combos
