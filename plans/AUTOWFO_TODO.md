...
- Active phase: **Phase 4 — Ranking Upgrade (Evidence-Driven)**
...
- Next action: Run one longer-horizon/high-frequency baseline window (same USDT symbol mix) to test whether persistent D3-only trigger is driven by short sample horizon rather than ranking quality
