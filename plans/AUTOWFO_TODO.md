...
- Next action: Run one targeted higher-frequency baseline window to test whether persistent D3-only trigger is driven by split granularity (timeframe/days) rather than symbol universe
