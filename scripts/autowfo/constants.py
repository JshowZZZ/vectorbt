...
LABELS = {
    ...
    "cci_lookback": _html_entity(_u("CCI \\u56de\\u770b(\\u6839)")),
    "cci_long": _html_entity(_u("CCI \\u591a\\u982d\\u9580\\u6abb")),
    "cci_short": _html_entity(_u("CCI \\u7a7a\\u982d\\u9580\\u6abb")),
    "willr_lookback": _html_entity(_u("Williams %R \\u56de\\u770b(\\u6839)")),
    "willr_long": _html_entity(_u("Williams %R \\u591a\\u982d\\u9580\\u6abb")),
    "willr_short": _html_entity(_u("Williams %R \\u7a7a\\u982d\\u9580\\u6abb")),
    "adx_lookback": _html_entity(_u("ADX \\u56de\\u770b(\\u6839)")),
    "adx_threshold": _html_entity(_u("ADX \\u9580\\u6abb")),
    "trix_lookback": _html_entity(_u("TRIX \\u56de\\u770b(\\u6839)")),
    "dpo_lookback": _html_entity(_u("DPO \\u56de\\u770b(\\u6839)")),
    "efi_lookback": _html_entity(_u("Elder Force \\u56de\\u770b(\\u6839)")),
    "vwma_lookback": _html_entity(_u("VWMA \\u56de\\u770b(\\u6839)")),
    "ultosc_long": _html_entity(_u("Ultimate Osc \\u591a\\u982d\\u9580\\u6abb")),
    "ultosc_short": _html_entity(_u("Ultimate Osc \\u7a7a\\u982d\\u9580\\u6abb")),
    "keltner_lookback": _html_entity(_u("Keltner \\u56de\\u770b(\\u6839)")),
    "keltner_long": _html_entity(_u("Keltner \\u591a\\u982d\\u9580\\u6abb")),
    "keltner_short": _html_entity(_u("Keltner \\u7a7a\\u982d\\u9580\\u6abb")),
    "donchian_lookback": _html_entity(_u("Donchian \\u56de\\u770b(\\u6839)")),
    "donchian_long": _html_entity(_u("Donchian \\u591a\\u982d\\u9580\\u6abb")),
    "donchian_short": _html_entity(_u("Donchian \\u7a7a\\u982d\\u9580\\u6abb")),
    "ppo_threshold": _html_entity(_u("PPO \\u9580\\u6abb")),
    "chop_lookback": _html_entity(_u("\\u6ce2\\u52d5\\u6307\\u6578 \\u56de\\u770b(\\u6839)")),
    "chop_threshold": _html_entity(_u("\\u6ce2\\u52d5\\u6307\\u6578 \\u9580\\u6abb")),
