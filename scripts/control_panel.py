...
from scripts import control_panel_state as cp_state_mod
from scripts import control_panel_config as cp_config_mod
from scripts import control_panel_batch as cp_batch_mod
from scripts import control_panel_coverage as cp_coverage_mod
from scripts import control_panel_results as cp_results_mod
from scripts import control_panel_signals as cp_signals_mod
from scripts import control_panel_dashboard as cp_dashboard_mod
from scripts import control_panel_data as cp_data_mod

# Re-export helper surfaces for compatibility with existing tests/callers.
from scripts.control_panel_state import *  # noqa: F401,F403
from scripts.control_panel_config import *  # noqa: F401,F403
from scripts.control_panel_batch import *  # noqa: F401,F403
from scripts.control_panel_coverage import *  # noqa: F401,F403
from scripts.control_panel_results import *  # noqa: F401,F403
from scripts.control_panel_signals import *  # noqa: F401,F403
from scripts.control_panel_dashboard import *  # noqa: F401,F403
from scripts.control_panel_data import *  # noqa: F401,F403
...
if __name__ == "__main__":
    # Register under canonical name so sub-modules can find us via sys.modules
    import sys as _sys
    _sys.modules.setdefault("scripts.control_panel", _sys.modules[__name__])
    main()
