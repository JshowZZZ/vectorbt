...
def _build_shared_pipeline_runtime_context(
    *,
    ...
    funding_gate_long_thresholds = list(funding_gate_long_thresholds or [])
    funding_gate_short_thresholds = list(funding_gate_short_thresholds or [])
    return {
        "base_symbol": base_symbol,
        "trade_symbols": trade_symbols,
        "exchange": exchange,
...
def _build_prepare_timeframe_runtime_context_from_shared(
    *,
    ...
    return _build_prepare_timeframe_runtime_context(
        ...
        oi_lookbacks=shared.get("oi_lookbacks"),
        open_interest_provider=shared.get("open_interest_provider", "bybit"),
